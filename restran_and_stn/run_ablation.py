#!/usr/bin/env python3
"""Automation script to run STN ablation experiments for ResTranOCR."""
...
def main() -> None:
    ...
    for experiment_config in experiments:
        ...
        try:
            ...
            results_summary.append({"name": experiment_name, "best_acc": best_accuracy})
    ...
    if results_summary:
        summary_lines = []
        summary_lines.append("=== ResTranOCR STN Ablation Summary ===")
